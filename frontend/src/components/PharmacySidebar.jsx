...
const navItems = [
  { name: 'Prescriptions Queue', icon: LayoutDashboard, href: '/prescription-medicine', active: true },
  { name: 'Druds Inventory', icon: Users, href: '/search-medicine' },
  { name: 'Add Medicine', icon: ShieldCheck, href: '/edit-medicine' },
